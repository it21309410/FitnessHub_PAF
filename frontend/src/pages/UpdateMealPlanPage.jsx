...
const UpdateMealPlanPage = () => {
  ...
  //const  mealplanId  = '6623725db4d5394ca02c6466';
    ...
    try {
      ...
      if (mealplanId) {
        ...
        if (res.status) {
          ...
          setMealType(mealPlanData.mealtype);
  ...
  const submitHandler = async () => {
    ...
    const url = `http://localhost:8080/api/user/mealplan/${mealplanId}`;


    axios
      .put(url, newmealPlanData)
      .then((response) => {
